...
// fs.readFile loads the whole file into memory at once, so the memory used grows
// with the size of the file. A stream moves the file in smaller chunks, so it
// does not need to hold the entire file in memory and peak memory stays flat.
